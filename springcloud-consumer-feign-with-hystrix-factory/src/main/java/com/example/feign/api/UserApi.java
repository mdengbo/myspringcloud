...
import com.example.feign.api.factory.UserApiHystrixFactoryImpl;
 ...
 *注意：fallback 和 fallbackFactory 选择其一选用  避免冲突
 * @Version 1.0
 **/
@FeignClient(name = "springcloud-provider", path = "/pro",/*fallback = UserApiHystrixImpl.class,*/ fallbackFactory = UserApiHystrixFactoryImpl.class)
